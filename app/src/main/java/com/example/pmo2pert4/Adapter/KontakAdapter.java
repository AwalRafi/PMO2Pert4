package com.example.pmo2pert4.Adapter;
...
import com.example.pmo2pert4.EditActivity;
import com.example.pmo2pert4.Model.Kontak;
import com.example.pmo2pert4.R;
...
public class KontakAdapter extends RecyclerView.Adapter<KontakAdapter.MyViewHolder>{
    ...
    public MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.kontak_list,
                parent, false);
